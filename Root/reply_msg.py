...
# This class implements a Python interface to the 'reply_msg'
# message type.
#
...
class reply_msg(tinyos.message.Message.Message):
    # Create a new reply_msg of size 15.
    ...
    #
    # Return the value (as a int) of the field 'request_code'
    #
    def get_request_code(self):
        return self.getUIntElement(self.offsetBits_request_code(), 16, 1)
    
    #
    # Set the value of the field 'request_code'
    #
    def set_request_code(self, value):
        self.setUIntElement(self.offsetBits_request_code(), 16, value, 1)
    ...
    #
    # Return the value (as a int) of the field 'request_device'
    #
    def get_request_device(self):
        return self.getUIntElement(self.offsetBits_request_device(), 16, 1)
    
    #
    # Set the value of the field 'request_device'
    #
    def set_request_device(self, value):
        self.setUIntElement(self.offsetBits_request_device(), 16, value, 1)
    ...
    #
    # Accessor methods for field: remark
    #   Field type: int
    #   Offset (bits): 88
    #   Size (bits): 16
    #
    ...
    #
    # Return whether the field 'remark' is signed (False).
    #
    def isSigned_remark(self):
        return False
    
    #
    # Return whether the field 'remark' is an array (False).
    #
    def isArray_remark(self):
        return False
    
    #
    # Return the offset (in bytes) of the field 'remark'
    #
    def offset_remark(self):
        return (88 / 8)
    
    #
    # Return the offset (in bits) of the field 'remark'
    #
    def offsetBits_remark(self):
        return 88
    
    #
    # Return the value (as a int) of the field 'remark'
    #
    def get_remark(self):
        return self.getUIntElement(self.offsetBits_remark(), 16, 1)
    
    #
    # Set the value of the field 'remark'
    #
    def set_remark(self, value):
        self.setUIntElement(self.offsetBits_remark(), 16, value, 1)
    
    #
    # Return the size, in bytes, of the field 'remark'
    #
    def size_remark(self):
        return (16 / 8)
    
    #
    # Return the size, in bits, of the field 'remark'
    #
    def sizeBits_remark(self):
        return 16
